...
from itembase.core.models import Client, Contact
...
class CreateClientContactView(SuccessMessageMixin, LoginRequiredMixin, StaffuserRequiredMixin,
                              CreateView):
    model = Contact
    ...
    def get_success_url(self):
        return reverse('clients:view', args=(self.object.slug,))


class UpdateClientContactView(LoginRequiredMixin, StaffuserRequiredMixin, UpdateView):
    model = Contact
...
class ListContactView(LoginRequiredMixin, StaffuserRequiredMixin, ListView):
    model = Contact
...
class CreateVendorContactView(CancelMixin, SuccessMessageMixin, LoginRequiredMixin, StaffuserRequiredMixin, CreateView):
    model = Contact
    template_name = 'core/contacts/contact_new.html'
...
class UpdateVendorContactView(LoginRequiredMixin, StaffuserRequiredMixin, UpdateView):
    model = Contact
    template_name = 'core/contacts/contact_edit.html'
    form_class = VendorContactForm
...
class DeleteContactView(LoginRequiredMixin, StaffuserRequiredMixin, DeleteView):
    model = Contact
...
class DetailContactView(LoginRequiredMixin, StaffuserRequiredMixin, DetailView):
    model = Contact
